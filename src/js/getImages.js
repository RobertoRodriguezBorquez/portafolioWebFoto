...
const estadioFolder = path.join(__dirname, 'public', 'GgaleriaAlbunFoto', 'estadio');
const senderismoFolder = path.join(__dirname, 'public', 'GgaleriaAlbunFoto', 'senderismo');
